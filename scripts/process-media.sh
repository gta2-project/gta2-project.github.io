...
mkdir -p "$PUBLIC_MEDIA" "$SOURCE_IMAGES"
...
for stem in ball cube iron drawer; do
	encode_video "$MATERIALS_DIR/grid_videos_all/${stem}_grid.mp4" "$PUBLIC_MEDIA/task-${stem}.mp4" 720 23
	make_poster "$PUBLIC_MEDIA/task-${stem}.mp4" "$PUBLIC_MEDIA/task-${stem}-poster.jpg" 7
done
...
encode_video "$MATERIALS_DIR/grid_videos_all/ipad_grid.mp4" "$PUBLIC_MEDIA/more-phone-call.mp4" 720 23
make_poster "$PUBLIC_MEDIA/more-phone-call.mp4" "$PUBLIC_MEDIA/more-phone-call-poster.jpg" 7
...
ffmpeg -hide_banner -loglevel error -y \
	...
	-ss 8.0 -t 6.0 -i "$MATERIALS_DIR/grid_videos_all/ipad_grid.mp4" \
	...
	-ss 8.0 -t 6.0 -i "$MATERIALS_DIR/grid_videos_all/ball_grid.mp4" \
	-ss 8.0 -t 6.0 -i "$MATERIALS_DIR/grid_videos_all/cube_grid.mp4" \
	-ss 10.0 -t 6.0 -i "$MATERIALS_DIR/grid_videos_all/iron_grid.mp4" \
	-ss 10.0 -t 6.0 -i "$MATERIALS_DIR/grid_videos_all/drawer_grid.mp4" \
	...
	-filter_complex "[0:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS,fade=t=in:st=0:d=0.35[v0];[1:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v1];[2:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v2];[3:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v3];[4:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v4];[5:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v5];[6:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v6];[7:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v7];[8:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v8];[9:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v9];[10:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v10];[11:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v11];[12:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v12];[13:v]crop=850:478:53:60,scale=1280:720:flags=lanczos,format=yuv420p,eq=gamma=0.88:contrast=1.04:saturation=0.92,setsar=1,setpts=0.5*(PTS-STARTPTS),fps=30,settb=AVTB,setpts=PTS-STARTPTS[v13];[14:v]scale=1280:720:flags=lanczos,fps=30,format=yuv420p,setsar=1,settb=AVTB,setpts=PTS-STARTPTS[v14];[15:v]scale=1280:720:flags=lanczos,fps=30,format=yuv420p,setsar=1,settb=AVTB,setpts=PTS-STARTPTS[v15];[16:v]scale=1280:720:flags=lanczos,fps=30,format=yuv420p,setsar=1,settb=AVTB,setpts=PTS-STARTPTS[v16];[17:v]scale=1280:720:flags=lanczos,fps=30,format=yuv420p,setsar=1,settb=AVTB,setpts=PTS-STARTPTS[v17];[18:v]scale=1280:720:flags=lanczos,fps=30,format=yuv420p,setsar=1,settb=AVTB,setpts=PTS-STARTPTS[v18];[19:v]scale=1280:720:flags=lanczos,fps=30,format=yuv420p,setsar=1,settb=AVTB,setpts=PTS-STARTPTS,fade=t=out:st=5.15:d=0.35[v19];[v0][v1]xfade=transition=fade:duration=0.24:offset=2.76[x1];[x1][v2]xfade=transition=fade:duration=0.24:offset=5.52[x2];[x2][v3]xfade=transition=fade:duration=0.24:offset=8.28[x3];[x3][v4]xfade=transition=fade:duration=0.24:offset=11.04[x4];[x4][v5]xfade=transition=fade:duration=0.24:offset=13.80[x5];[x5][v6]xfade=transition=fade:duration=0.24:offset=16.56[x6];[x6][v7]xfade=transition=fade:duration=0.24:offset=19.32[x7];[x7][v8]xfade=transition=fade:duration=0.24:offset=22.08[x8];[x8][v9]xfade=transition=fade:duration=0.24:offset=24.84[x9];[x9][v10]xfade=transition=fade:duration=0.24:offset=27.60[x10];[x10][v11]xfade=transition=fade:duration=0.24:offset=30.36[x11];[x11][v12]xfade=transition=fade:duration=0.24:offset=33.12[x12];[x12][v13]xfade=transition=fade:duration=0.24:offset=35.88[x13];[x13][v14]xfade=transition=fade:duration=0.24:offset=38.64[x14];[x14][v15]xfade=transition=fade:duration=0.24:offset=42.40[x15];[x15][v16]xfade=transition=fade:duration=0.24:offset=46.36[x16];[x16][v17]xfade=transition=fade:duration=0.24:offset=50.32[x17];[x17][v18]xfade=transition=fade:duration=0.24:offset=54.88[x18];[x18][v19]xfade=transition=fade:duration=0.24:offset=59.14[mixed];[mixed]setparams=range=tv:color_primaries=bt709:color_trc=bt709:colorspace=bt709[outv]" \
	-map "[outv]" -c:v libx264 -profile:v high -level 4.1 -preset medium -crf 25 \
